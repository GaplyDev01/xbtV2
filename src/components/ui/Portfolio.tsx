        ...
        <div className="flex mb-2">
          <div className="w-24 h-24 relative">
            ...
            <svg viewBox="0 0 100 100" className="w-full h-full">
              ...
              <circle cx="50" cy="50" r="45" fill="transparent" stroke="rgb(var(--theme-accent) / 1)" strokeWidth="10" strokeDasharray="282.7" strokeDashoffset="155.5" />
              ...
              <tbody>
                {assets.map((asset, index) => (
                  <tr key={index}>
                    ...
                    <td className={`py-0.5 text-right text-theme-accent`}>
                      {asset.change}
                    </td>
                  </tr>
                ))}
